...
%   2. Au, Siu-Kui. Fast Bayesian ambient modal identification in the 
%       frequency domain, Part II: Posterior uncertainty. Mechanical 
%       Systems and Signal Processing, 2012,26:76-90.
%
...
%
% Note: The EM does not work well for modal signal-to-noise ratio S/(4z^2*Se)
